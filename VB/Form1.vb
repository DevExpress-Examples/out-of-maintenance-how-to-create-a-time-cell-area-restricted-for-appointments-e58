...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Private Sub schedulerControl1_AllowAppointmentConflicts(ByVal sender As Object, ByVal e As DevExpress.XtraScheduler.AppointmentConflictEventArgs) Handles schedulerControl1.AllowAppointmentConflicts
			If (e.Interval.Start.Hour >= 12 AndAlso e.Interval.Start.Hour < 14) OrElse ((e.Interval.End.Hour > 12 OrElse (e.Interval.End.Hour = 12 AndAlso e.Interval.End.Minute <> 0)) AndAlso e.Interval.End.Hour < 14) OrElse (e.Interval.Start.Hour <= 12 AndAlso e.Interval.End.Hour >= 14) Then
